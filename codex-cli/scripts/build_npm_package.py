#!/usr/bin/env python3
"""Stage and optionally package the @runnly/runnly npm module."""
...
CODEX_NPM_NAME = "@runnly/runnly"

# `npm_name` is the local optional-dependency alias consumed by `bin/codex.js`.
# The underlying package published to npm is always `@runnly/runnly`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "@runnly/runnly-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "codex-linux-arm64": {
        "npm_name": "@runnly/runnly-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "codex-darwin-x64": {
        "npm_name": "@runnly/runnly-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "codex-darwin-arm64": {
        "npm_name": "@runnly/runnly-darwin-arm64",
    ...
    "codex-win32-x64": {
        "npm_name": "@runnly/runnly-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "codex-win32-arm64": {
        "npm_name": "@runnly/runnly-win32-arm64",
        "npm_tag": "win32-arm64",
